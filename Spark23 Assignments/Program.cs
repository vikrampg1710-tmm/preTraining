   ...
   public static void Main () {
      ...
      for (; ; ) {
         ...
         if (int.TryParse (Console.ReadLine (), out int n) && n > 0 && n < 23) {
            ...
            Thread.Sleep (1000);
            switch (n) {
               case 1: Q1.NumberConverter(); break;
               case 2: Q2.NumberToNumerals(); break;
               case 3: Q3.Fibonacci(); break;
               case 4: Q4.GCDnLCD(); break;
               ...
               case 17: Q17.StringPermutation(); break;
               case 18: Q18.IsArmstrongNum(); break;
               case 19: Q19.NthArmstrongNum(); break;
               case 20: Q20.DigitParse(); break;
